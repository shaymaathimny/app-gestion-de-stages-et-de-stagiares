...
@Component({
  ...
  templateUrl: './listencadreur.component.html',
  styleUrls: ['./listencadreur.component.css']
})
export class ListencadreurComponent implements OnInit {
  ...
  ajoutencadreur(){
    this.router.navigate(['ajoutencadr']);
  ...
  Modifencadreur(id:any){
    //alert(id);
    this.router.navigate(['modifencadr'],{queryParams:{_id:id}});

  }
    encadreurDetails(id: number){
    this.router.navigate(['detailencadreur', id]);
